...
-   <span class="package-name">[`@stdlib/assert-has-arraybuffer-support-cli`][@stdlib/assert-has-arraybuffer-support-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/assert-has-arraybuffer-support-cli]: https://www.npmjs.com/package/@stdlib/assert-has-arraybuffer-support-cli
