...
-   <span class="package-name">[`@stdlib/assert-has-dataview-support-cli`][@stdlib/assert-has-dataview-support-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/assert-has-dataview-support-cli]: https://www.npmjs.com/package/@stdlib/assert-has-dataview-support-cli
